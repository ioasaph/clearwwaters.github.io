...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/jszip/lib/external.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/jszip/lib/external.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/* global Promise */
'use strict';
