...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/fake_node_modules/powercord/compilers/less.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/fake_node_modules/powercord/compilers/less.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const less = require('less');
