...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/stylus/lib/functions/current-media.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/stylus/lib/functions/current-media.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var nodes = require('../nodes');
