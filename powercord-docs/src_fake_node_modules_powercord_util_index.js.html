...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/fake_node_modules/powercord/util/index.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/fake_node_modules/powercord/util/index.js</h1>
...
module.exports = {
  ...
  forceUpdateElement: require('./forceUpdateElement'),
