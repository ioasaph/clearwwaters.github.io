...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/fake_node_modules/keybindutils/localShortcut.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/fake_node_modules/keybindutils/localShortcut.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// Taken from https://github.com/parro-it/electron-localshortcut/blob/master/index.js, licensed under MIT license
