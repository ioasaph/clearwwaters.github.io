...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/less/test/browser/generator/template.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/less/test/browser/generator/template.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const html = require('html-template-tag')
