...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/fake_node_modules/powercord/http/GenericRequest.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/fake_node_modules/powercord/http/GenericRequest.js</h1>
