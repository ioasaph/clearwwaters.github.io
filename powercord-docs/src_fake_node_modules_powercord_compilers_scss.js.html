...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/fake_node_modules/powercord/compilers/scss.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/fake_node_modules/powercord/compilers/scss.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const { info: sassInfo } = require('sass');
...
class SCSS extends Compiler {
  ...
  _compile () {
    return PowercordNative.__compileSass(this.file);
  }
  ...
  get _metadata () {
    return `${sassInfo}; Powercord import resolver v1`;
  }
}
