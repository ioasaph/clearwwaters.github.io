...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/yaku/lib/genIterator.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/yaku/lib/genIterator.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var _ = require("./_");
