...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/fake_node_modules/powercord/entities/Updatable.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/fake_node_modules/powercord/entities/Updatable.js</h1>
...
class Updatable extends Events {
  ...
  async __migrateIfNecessary () {
    ...
    if (!newUrl) {
      ...
      await exec(`git remote set-url origin "${newUrl}"`, this._cwd);
    }
  }
