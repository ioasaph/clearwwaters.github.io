...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/less/test/browser/generator/generate.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/less/test/browser/generator/generate.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const template = require('./template')
let config
