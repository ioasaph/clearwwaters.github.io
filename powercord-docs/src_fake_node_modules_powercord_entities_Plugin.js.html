...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/fake_node_modules/powercord/entities/Plugin.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/fake_node_modules/powercord/entities/Plugin.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const { existsSync } = require('fs');
