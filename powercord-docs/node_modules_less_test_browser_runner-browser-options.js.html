...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/less/test/browser/runner-browser-options.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/less/test/browser/runner-browser-options.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var less = {
    logLevel: 4, 
