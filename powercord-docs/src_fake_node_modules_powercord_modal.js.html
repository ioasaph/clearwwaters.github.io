...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/fake_node_modules/powercord/modal.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/fake_node_modules/powercord/modal.js</h1>
...
module.exports = {
  ...
  open: (Component) => {
    modal.push(
      class PowercordModal extends React.PureComponent {
        render () {
